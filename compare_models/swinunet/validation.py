...
class Trainer(object):
    def __init__(self, args):
        ...
        model = ViT_seg(config, img_size=224, num_classes=self.nclass)
        ...
        # Define Optimizer
        optimizer = torch.optim.SGD(model.parameters(), lr=self.args.base_lr, momentum=0.9, weight_decay=0.0001)
        ...
        # Define lr scheduler
        self.scheduler = LR_Scheduler(args.lr_scheduler, args.base_lr,
...
def main():
    ...
    # optimizer params
    parser.add_argument('--base_lr', type=float, default=None, metavar='LR',
    ...
    if args.base_lr is None:
        ...
        args.base_lr = lrs[args.dataset.lower()] / (4 * len(args.gpu_ids)) * args.batch_size
