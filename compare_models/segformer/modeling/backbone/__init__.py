from modeling.backbone import resnet, xception, drn, mobilenet, mix_transformer_yuan, swin_transformer
...
def build_backbone(backbone, output_stride, BatchNorm, aux):
    if backbone == 'resnet':
        ...
        return mix_transformer_yuan.build_transformer(aux=aux)
