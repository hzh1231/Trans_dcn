...
from modeling.hamburger import Hamburger
from modeling.bricks import SeprableConv2d, ConvRelu, ConvBNRelu, resize
...
class decoder_head(nn.Module):
    ...
    def __init__(self, outChannels, config, enc_embed_dims=[32,64,460,256]):
        ...
        self.hamburger = Hamburger(ham_channels, config)
