...
from modeling.laaspp_model import lraspp_mobilenetv3_large
...
class Trainer(object):
    def __init__(self, args):
        ...
        # Define network
        model = lraspp_mobilenetv3_large(num_classes=self.nclass)
        ...
        # Define Optimizer
        optimizer = torch.optim.SGD(model.parameters(), lr=0.007, momentum=0.9, weight_decay=0.0001)
...
def main():
    ...
    parser.add_argument('--backbone', type=str, default='bitformer',
                        choices=['resnet', 'xception', 'drn', 'mobilenet', 'mix_transformer', 'swin_transformer', 'convnext', 'bitformer'],
