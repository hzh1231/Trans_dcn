...
parser.add_argument('--model', type=str, default='denseaspp_densenet121_voc',
...
parser.add_argument('--inputdir', type=str, default='../test',
...
def demo(config):
    ...
    for name in os.listdir(args.inputdir):
        image = Image.open(args.inputdir+"/"+name).convert('RGB')
        ...
        mask.save(args.outdir+"/"+"{}_mask.png".format(name[0:-4]))
