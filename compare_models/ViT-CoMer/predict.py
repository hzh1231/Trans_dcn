...
def main():
    ...
    parser.add_argument('--backbone', type=str, default='deit',
                        choices=['resnet', 'xception', 'drn', 'mobilenet', 'mix_transformer', 'deit'],
                        help='backbone name (default: resnet)')
    parser.add_argument('--ckpt', type=str, default='./run/pascal/deeplab-deit/experiment_1/checkpoint.pth.tar',
                        help='saved model')
    ...
    if args.cam:
        ...
        target_layers = [model.aspp.conv1]
