...
def main():
    ...
    parser.add_argument('--backbone', type=str, default='deit',
                        choices=['resnet', 'xception', 'drn', 'mobilenet', 'mix_transformer', 'swin_transformer', 'deit'],
    ...
    parser.add_argument('--batch-size', type=int, default=3, help='input batch size for  training (default: auto)')
